...
const Footer = () => {
  return (
    <footer className="flex flex-col justify-start max-w-7xl mx-auto px-2 md:px-1 lg:px-0">
      <div className="flex flex-col md:flex-row justify-center md:justify-around items-center md:items-start py-10 bg-black border-b-2 border-white px-5">
        <div className="newsletter flex flex-col justify-center items-center gap-8 md:mt-6">
          <Image
            ...
            height={100}
          />
          <div className="flex w-full max-w-md items-center border border-slate-300 bg-slate-300 rounded-md overflow-hidden shadow-md ">
            {/* Input Field */}
            <Input
              type="email"
              placeholder="Sign-Up For Newsletters"
              className="flex-1 px-6 py-4 text-black bg-white placeholder-black focus:outline-none rounded border-4 border-slate-300"
            />
            {/* Button */}
            <Button
              type="submit"
              className="bg-teal-600 text-white font-bold px-6 py-4 hover:bg-teal-700 rounded border-slate-300 border-4"
            >
              GO
            </Button>
          </div>
        ...
        <div className="links hidden sm:flex flex-col justify-start items-start my-5 md:my-0">
        ...
        <div className="company hidden sm:flex flex-col justify-start items-start my-5 md:my-0">
          <p className="text-blue-400 font-raleway mb-4 font-semibold">
            Company
          </p>
      ...
      <div className="flex flex-row sm:hidden justify-between items-start py-10 bg-black border-b-2 border-white px-5">
        <div className="links flex flex-col justify-start items-start my-5 md:my-0">
          <p className="text-blue-400 font-raleway mb-4 font-semibold">Links</p>
          <Link className="text-white font-raleway" href="/games">
            Games
          </Link>
        ...
        <div className="company flex flex-col justify-start items-start my-5 md:my-0">
          <p className="text-blue-400 font-raleway mb-4 font-semibold">
            Company
          </p>
          <Link className="text-white font-raleway" href="/about-us">
