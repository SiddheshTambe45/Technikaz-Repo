  ...
  return (
    <section className="lg:col-span-1 px-3">
      ...
      <div>
        <div>
          <div className="p-0 m-0 border-b-4 b-generic-viridian">
            <button className="bg-generic-viridian text-white px-6 py-2">
              Upcomings
            </button>
          </div>
          <div className="flex flex-row justify-around items-center my-4">
            {["Games", "Phone", "Movies", "More"].map((category) => (
              <button
                ...
                className="generic-viridian font-bold"
                onClick={() =>
                  setSelectedCategory(category as UpcomingCategory)
        ...
        <div className="border-2 b-generic-viridian p-2">
          {upcomingItems.map((item, index) => (
            <Link
              ...
              href={`/${item.category.toLowerCase()}/${item.slug}`}
            >
              <div className="relative w-full aspect-[16/9] min-h-[50px] col-span-1">
                <Image
                  src={item.imageUrl}
                  alt={item.title}
                  fill
              ...
              <div className="flex flex-col justify-content-center items-start w-full col-span-2">
