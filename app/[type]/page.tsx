...
// import SubTypeHeading from "./subTypeHeading";
// import Link from "next/link";

// const staticSubTypes: Record<string, { subtype: string }[]> = {
//   tech: [{ subtype: "techdeals" }, { subtype: "news" }],
//   mobile: [{ subtype: "smartphone" }, { subtype: "accessory" }],
//   stock: [{ subtype: "stock" }],
//   entertainment: [
//     { subtype: "movie" },
//     { subtype: "series" },
...
//       <CategoryHeroSection
//         params={{ type, selectedSubType: selectedSubType || "" }}
//       />
...
//       <section>
//         <Bloglist params={{ type, selectedSubType: selectedSubType || "" }} />
//       </section>
//     </div>
//   );
// };
...
// Type definition for Params (which is a Promise)
type Params = Promise<{ type: string }>;
type SearchParams = Promise<{ subtype?: string }>;
...
const Page = async ({
  ...
  // Await params and searchParams as Promises
  const resolvedParams = await params;
  const resolvedSearchParams = await searchParams;

  const type = resolvedParams.type || ""; // Extract the type from resolved params
  const selectedSubType = resolvedSearchParams.subtype || null; // Get selected subtype
